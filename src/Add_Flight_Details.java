...
public class Add_Flight_Details extends javax.swing.JFrame {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(seats_av, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void Add_FlightActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Add_FlightActionPerformed
        ...
        {
        try{
            String sql="insert into flight(Flight_Id,Flight_Name,Source,Destination,Date,Arrival_Time,Departure_Time,Flight_Price,Seats_Av)values(?,?,?,?,?,?,?,?,?)";
            pst=conn.prepareStatement(sql);
            ...
            pst.setString(9,seats_av.getText());
            //pst.setInt(9,seats.getInt());
    ...
    private void UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateActionPerformed
        ...
        String date=da.format(Date.getDate());
        try{
            String sql="update flight set Flight_Name=?, Source=?, Destination=?, Date=?, Arrival_Time=?, Departure_Time=?, Flight_Price=?, Seats_Av=? where Flight_Id=?";
            pst=conn.prepareStatement(sql);
            ...
            pst.setString(8, seats_av.getText());
            pst.executeUpdate();
             fetch();
