...
public class Search_Flight_Details extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        seats_av = new javax.swing.JTextField();
        ...
        jTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Flight_Id", "Flight_Name", "Source", "Destination", "Date", "Arrival_Time", "Departure_Time", "Flight_Price", "Seats_Av"
            }
        ));
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                            ...
                                            .addGroup(layout.createSequentialGroup()
                                                .addComponent(fid, javax.swing.GroupLayout.PREFERRED_SIZE, 62, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(18, 18, 18)
                                                .addComponent(jLabel18, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(seats_av))))
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(seats_av, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
    ...
    private void jTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableMouseClicked
        try {
            ...
            seats_av.setText(Df.getValueAt(selectIndex, 8).toString());            
...
//            pst.setString(3, seats_av.getText());
...
//            pst.setString(13,seats_av.getText());
            
            pst.execute();
//            // updation
//            int sa= Integer.parseInt(seats_av.getText());
//            int sb= Integer.parseInt(seats.getValue().toString());
//            sa=sa-sb;
//            String sa2=Integer.toString(sa);
//            sql="update flight set Seats_Av=? where Flight_Id=?";
//            pst.setString(1,seats_av.getText());
//            pst.setString(2,fid.getText());
//            pst=conn.prepareStatement(sql);
//            pst.executeUpdate();
//            
...
//         //ends
    ...
    private void Seats_changed(java.awt.event.ActionEvent evt){
        int sa= Integer.parseInt(seats_av.getText());
        int sb= Integer.parseInt(seats.getValue().toString());
        sa=sa-sb;
        String sql="update flight set Seats_Av=? where Flight_Id=?";
         
        seats_av.setText(String.valueOf(sa));
    }
    ...
    private javax.swing.JTextField seats_av;
